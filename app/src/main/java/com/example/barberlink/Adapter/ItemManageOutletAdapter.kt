...
class ItemManageOutletAdapter(
    ...
    fun setEmployeeList(userEmployeeDataList: List<UserEmployeeData>) {
                ...
                switch2.setOnCheckedChangeListener { _, isChecked ->
                    ...
                    if (!isChecked) {
                        ...
                        if (sumOfCurrentQueue > 0) {
                            ...
                            val hasAttendanceEmployee = filteredEmployeeList.any { it.attendanceStatus }
                            Log.d("SwitchAnomali", "FilteredEmployeeSize: ${filteredEmployeeList.size} || hasAttendanceEmployee: $hasAttendanceEmployee")

                            if (hasAttendanceEmployee && isSameDay) {
