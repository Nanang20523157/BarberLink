...
import com.example.barberlink.databinding.ItemListCounterProductAdapterBinding
import com.example.barberlink.databinding.ShimmerLayoutCounterProductBinding

class ItemListCounterProductAdapter : ListAdapter<Product, RecyclerView.ViewHolder>(ProductDiffCallback()) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return if (viewType == VIEW_TYPE_SHIMMER) {
            val shimmerBinding = ShimmerLayoutCounterProductBinding.inflate(inflater, parent, false)
            ShimmerViewHolder(shimmerBinding)
        } else {
            val binding = ItemListCounterProductAdapterBinding.inflate(inflater, parent, false)
