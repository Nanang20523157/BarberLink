...
import com.example.barberlink.databinding.ItemListDetailItemProductAdapterBinding
import com.example.barberlink.databinding.ShimmerLayoutDetailItemServiceBinding

class ItemListDetailItemProductAdapter : ListAdapter<Product, RecyclerView.ViewHolder>(ProductDiffCallback()) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return if (viewType == VIEW_TYPE_SHIMMER) {
            ...
            val binding = ItemListDetailItemProductAdapterBinding.inflate(inflater, parent, false)
    ...
    inner class ItemViewHolder(private val binding: ItemListDetailItemProductAdapterBinding) :
        RecyclerView.ViewHolder(binding.root) {
