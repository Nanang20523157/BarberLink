...
import com.example.barberlink.databinding.FragmentDetailServiceListBinding
import com.google.android.material.bottomsheet.BottomSheetBehavior
import com.google.android.material.bottomsheet.BottomSheetDialog
import com.google.android.material.bottomsheet.BottomSheetDialogFragment

class DetailServiceListFragment : BottomSheetDialogFragment() {

    private var _binding: FragmentDetailServiceListBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDetailServiceListBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    companion object {
        ...
        fun newInstance(serviceList: List<Service>): DetailServiceListFragment {
            val args = Bundle().apply {
                putParcelableArrayList(ARG_SERVICE_LIST, ArrayList(serviceList))
            }
            return DetailServiceListFragment().apply {
                arguments = args
            }
        }
    }
